...
1. [`01_top_demanded_skills.sql`](./English_version/1_EDA/01_top_demanded_skills/01_top_demanded_skills.sql) – demand analysis with multi-table joins  
2. [`02_top_paying_skills.sql`](./English_version/1_EDA/02_top_paying_skills/02_top_paying_skills.sql) – salary analysis with aggregations  
3. [`03_optimal_skills.sql`](./English_version/1_EDA/03_optimal_skills/03_optimal_skills.sql) – combined demand/salary optimization query  
...
![Data Warehouse Schema](src/images/1_2_Data_Warehouse.png)
...
1. **[Top Demanded Skills](./English_version/1_EDA/01_top_demanded_skills/)** – Identifies the 10 most in-demand skills for remote data engineer positions
2. **[Top Paying Skills](./English_version/1_EDA/02_top_paying_skills/)** – Analyzes the 25 highest-paying skills with salary and demand metrics
3. **[Optimal Skills](./English_version/1_EDA/03_optimal_skills/)** – Calculates an optimal score using natural log of demand combined with median salary to identify the most valuable skills to learn
